//please note that if you want to see the result call/invoke the function by the name of the selected function
...
function sigma(num){
  var sum = 0;
  for (let i = 1; i <= num /*or i < num+1 */; i++) {
    sum += i;
  }
  return sum;
}
...
//of all positive integers from 1 up to the given number (inclusive).  For example, 
...
//each number is the sum of the previous two, starting with values 0 and 1.  Your function should accept
// one argument, an index into the sequence (where 0 corresponds to the initial value, 4 corresponds 
...
//If you don't know what a recursion is yet, don't worry as we'll be introducing 
//this concept in Part 2 of this assignment.
...
//retaining original order.  Convert [4, "Ulysses", 42, false] to
